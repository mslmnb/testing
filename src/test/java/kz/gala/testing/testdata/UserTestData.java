...
public class UserTestData {
    ...
    public static final ModelMatcher<ExamReport> MATCHER_REPORT = ModelMatcher.of(ExamReport.class);
    ...
    public static final ExamReport USER_REPORT = new ExamReport(USER,9,0,0);
